    ...
    editClub(id) {
        ...
        this.setState({
            ...
            $get('/clubs/admin/' + id).then(res => {
                ...
                let tags =[]
                if(tmpClub.tags[1]!=undefined){
                    tags.push(tmpClub.tags[1])
                }else if(tmpClub.tags[2]!=undefined){
                    tags.push(tmpClub.tags[2])
                }else if(tmpClub.tags[3]!=undefined){
                    tags.push(tmpClub.tags[3])
                }
